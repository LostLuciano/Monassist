...
// GET /shortcuts/download (Deprecated: iOS rejects direct .shortcut imports in many flows)
router.get('/shortcuts/download', (req, res) => {
  res.status(410).json({
    success: false,
    message: 'Impor file .shortcut lewat download tidak didukung. Gunakan tautan iCloud atau buat pintasan manual dari panduan MoneyAssist.'
  });
});
